          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav d-flex flex-row align-items-center w-100 justify-content-between">
              <li className="nav-item">
                <Link to="/" className="nav-link active" aria-current="page" onClick={()=>setQuery("")} style={{ marginLeft: '1rem' }}>
              ...
              <li className="nav-item">
                <h1 style={{ fontSize: '19px', marginLeft: '2rem', marginTop: '0.6rem' }}>
                  <Link to="/brands" onClick={()=>setQuery("")} style={{ color: 'navy', textDecoration: 'none' }}>Brands</Link>
                </h1>
              </li>
              <li className="nav-item">
              ...
              <li className="py-1" style={{ marginLeft: '12rem', marginRight: '1rem' }}>
                <Link to="/cart-items" onClick={()=>setQuery("")}>
