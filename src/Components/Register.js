...
const Register=()=>{
  ...
  const [formData, setFormData] = useState({
    ...
    return(
        <>
            <div style={{width:'50%',margin:'auto',borderRadius:'5px',padding: '2rem'}}>    <h1 className="bold text-center" style={{color:'navy'}}>Register</h1>
  ...
  <button type="submit" className="btn" style={{backgroundColor:'#3b7c7e', color:'white', width:'40%',textAlign:'center'}}
      >Register</button>
  </div>
  <br/>
  <p style={{textAlign:'center'}}>Existing User?: <Link to='/login' style={{color:'rgb(255, 186, 12)', textDecoration:'none'}}>
    <b>Login Here</b></Link>
  </p>
</form>
        </div>
